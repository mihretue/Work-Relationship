            ...
            Cell: ({ row }) => {
                ...
                return (
                    <div className="action-buttons">
                        <Button size="xs" color="blue" onClick={() => handleView(row.original)}>View</Button>
                        {!forwarded_to_director && (
                            <>
                                <Button size="xs" color="red" onClick={() => handleDelateFlag(row.original)}>Delete</Button>
                                <Button size="xs" color="green" onClick={() => handleForward(row.original)}>Forward</Button>
                                <Button size="xs" color="yellow" onClick={() => handleEditModal(row.original)}>Edit</Button>
                            </>
                        )}
                        {approved && (
                            <Button size="xs" color="blue" onClick={() => handleStatus(row.original)}>Update Status</Button>
                        )}
                    </div>
                );
            },
